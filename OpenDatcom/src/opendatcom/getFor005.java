...
public class getFor005 {
    ...
    public String createOutputFile(String caseID, ArrayList FLTCON, ArrayList OPTINS, ArrayList SYNTHS, String BODY, ArrayList WGPLNF, ArrayList HTPLNF, ArrayList VTPLNF, ArrayList TERMINATION)
    {
