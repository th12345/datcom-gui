...
public class WriteAeroTables {
    ...
    public WriteAeroTables(String for005){
    this.for005 = for005;

    }

    public String alterInputFile(String newMACHs, String newALTs){
        this.newMACH =null;
        this.newALT = null;
    ...
    public ArrayList grabParametersFromOutputFile(String workPath){
        //parse.parseXML(path);
        ...
        try {
            for006 = getFile.getTextFromFile(path);
        } catch (FileNotFoundException ex) {
            Logger.getLogger(WriteAeroTables.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void createMasterAeroTable(String workingPath, String printMACH, String printALT, int key, String masterPath)
    {
        //path = workingPath;
        initialStart = key;
        MASTER = null;
